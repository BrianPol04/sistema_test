                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                     ...
                                     @csrf
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password" class="form-control pe-5 password-input @error('password') is-invalid @enderror"   value="sistemas"  name="password" placeholder="Enter password" id="password-input" required>
                        ...
                        <div class="mt-4 text-center">
                            {{-- <p class="mb-0">¿No tienes una cuenta?<a href="{{url('/register')}}" class="fw-semibold text-primary text-decoration-underline"> Signup </a> </p> --}}
                        </div>
