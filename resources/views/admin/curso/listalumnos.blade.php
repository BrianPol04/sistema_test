                            ...
                            <div class="col-xl-6">
                                <div class=" mt-4">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <label for="light" class="color-select avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-20 text-light">
                                            <input type="radio" name="color" id="light" value="light" class="d-none" onchange="changeColor(this)">
                                            <i class="ri-checkbox-blank-circle-fill"></i>
                                        </label>
                            ...
                            <div class="col-xl-6 col-md-12 col-sm-12">
                                <div class="card {{ 'card-' . $item->color }} pb-0">
                                    <div class="card-body p-0 ">
                                        <div class="alert border-0 rounded-top rounded-0 m-0 d-flex align-items-center  shadow-lg  cursor-pointer" onclick="window.location.href = '{{ url('axamenview?cod=') . base64_encode($item->id) }}';" role="alert">
                                            ...
                                            <div class="flex-shrink-0"> 
                                                <div class="float-end ">
                                                    <span>
                                                        @if ($item->examen_activo  > 0)
                                                        <b class="d-flex gap-1">Examen activo <i class="avatar-title rounded-circle bg-soft-light text-light me-2 icon-sm"> <small>{{ $item->examen_activo}}</small> </i> </b>
                                                        @endif
                                                    </span> 
                                                </div>  
                                            </div>
                                        ...
                                        <div class="">
                                            <div class="p-2 pb-0" style="height: 120px">
